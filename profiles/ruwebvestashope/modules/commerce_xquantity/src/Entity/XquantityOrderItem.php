...
class XquantityOrderItem extends OrderItem {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['quantity'] = BaseFieldDefinition::create('xdecimal')
      ...
      ->setSetting('min', 0)
      ->setDefaultValue(1)
      ->setDefaultValueCallback('Drupal\commerce_xquantity\Entity\XquantityOrderItem::getDefaultValue')
   ...
   * {@inheritdoc}
   */
  public static function getDefaultValue(XquantityOrderItem $item) {
    extract($item->getQuantityWidgetSettings());
    return !empty($default_value) ? $default_value : $step;
  }
