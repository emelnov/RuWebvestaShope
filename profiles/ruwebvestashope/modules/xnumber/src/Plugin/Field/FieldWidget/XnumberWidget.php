...
class XnumberWidget extends NumberWidget {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state) {
    ...
    $element['step'] = [
      ...
      '#field_suffix' => "min {$step_min}, max {$max} <mark><strong>Save it first!</strong></mark>",
    ...
    if (isset($field_settings['size']) && $field_settings['size'] == 'big') {
      $element['step']['#max'] = '1';
      $element['step']['#field_suffix'] = $this->t('With this size:  min 1, max 1');
    }
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    $settings = $this->getFormDisplayModeSettings();
    $value = isset($items[$delta]->value) ? Numeric::toString($items[$delta]->value) : NULL;
  ...
  public function getFormDisplayModeSettings() {
    ...
    $default_value = is_numeric($default_value) ? Numeric::toString($default_value) : $none;
    $settings['default_value'] = is_numeric($settings['default_value']) ? Numeric::toString($settings['default_value']) : $default_value;
