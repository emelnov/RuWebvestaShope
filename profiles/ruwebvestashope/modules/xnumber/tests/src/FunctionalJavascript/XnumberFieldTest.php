...
namespace Drupal\Tests\xnumber\FunctionalJavascript;
...
/**
 * Tests the Xnumber field widget.
 *
 * @group field
 */
class XnumberFieldTest extends WebDriverTestBase {

  /**
   * {@inheritdoc}
   */
  protected static $modules = ['node', 'entity_test', 'field_ui', 'xnumber'];
