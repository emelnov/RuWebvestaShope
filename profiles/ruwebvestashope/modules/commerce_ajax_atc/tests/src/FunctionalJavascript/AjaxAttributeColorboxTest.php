 ...
 * @group commerce
 */
class AjaxAttributeColorboxTest extends AjaxAttributeTestBase {
   ...
   */
  public function testColorboxAttributes() {
    // Set and check the colorbox message as a custom message.
    ...
    $this->assertSession()->elementContains('css', '#cboxLoadedContent', 'Product with attributes - Red, Small has been added to');
    ...
    $this->getSession()->getPage()->pressButton('Add to cart');
    $this->assertSession()->assertWaitOnAjaxRequest();
    $this->assertSession()->elementContains('css', '#cboxLoadedContent', 'Product with attributes - Blue, Medium has been added to');
    $this->assertSession()->elementContains('css', '#cboxLoadedContent', 'your cart');
    $this->getSession()->getPage()->clickLink('Continue shopping');
    ...
    $this->getSession()->getPage()->pressButton('Add to cart');
    $this->assertSession()->assertWaitOnAjaxRequest();
    $this->assertSession()->elementContains('css', '#cboxLoadedContent', 'Product with attributes - Red, Medium has been added to');
    $this->assertSession()->elementContains('css', '#cboxLoadedContent', 'your cart');
    $this->getSession()->getPage()->clickLink('Continue shopping');
