 ...
 * @group commerce
 */
class AjaxAttributeModalTest extends AjaxAttributeTestBase {

  /**
   * Tests adding a product to the cart when there are multiple variations.
   */
  public function testModalAttributes() {
    // Set and check the modal message as a custom message.
    ...
    $this->assertSession()->elementContains('css', '.ui-dialog', 'Product with attributes - Red, Small has been added to');
    ...
    $this->getSession()->getPage()->pressButton('Add to cart');
    $this->assertSession()->assertWaitOnAjaxRequest();
    $this->assertSession()->elementContains('css', '.ui-dialog', 'Product with attributes - Blue, Medium has been added to');
    $this->assertSession()->elementContains('css', '.ui-dialog', 'your cart');
    $this->assertSession()->waitforButton('Continue shopping')->press();
    ...
    $this->getSession()->getPage()->pressButton('Add to cart');
    $this->assertSession()->assertWaitOnAjaxRequest();
    $this->assertSession()->elementContains('css', '.ui-dialog', 'Product with attributes - Red, Medium has been added to');
    $this->assertSession()->elementContains('css', '.ui-dialog', 'your cart');
    $this->assertSession()->waitforButton('Continue shopping')->press();
