...
class SnowballStemmer extends StemmerProcessor {
  ...
  public static function supportsIndex(IndexInterface $index): bool {
    ...
    $stemmer = \Drupal::getContainer()->get('snowball_stemmer.stemmer');
    // Make processor available only if a supported language is available.
    foreach ($languages as $language) {
      if ($stemmer->setLanguage($language->getId())) {
        return TRUE;
      }
    }
    return FALSE;
