...
abstract class PhotoswipeJsTestBase extends WebDriverTestBase {
  ...
  protected function validateCdnLibraries($session): void {
    $session->elementExists('css', 'link[href*="//cdnjs.cloudflare.com/ajax/libs/photoswipe/5.4.2/photoswipe.min.css"]');
    $session->elementExists('css', 'script[src*="//cdnjs.cloudflare.com/ajax/libs/photoswipe/5.4.2/umd/photoswipe-lightbox.umd.min.js"]');
    $session->elementExists('css', 'script[src*="//cdnjs.cloudflare.com/ajax/libs/photoswipe/5.4.2/umd/photoswipe.umd.min.js"]');
  }
